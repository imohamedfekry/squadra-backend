...
const CreateUserHeaderSchema = v.object({
  authorizationtemp: v.pipe(
    v.string('authorizationtemp is required'),
    v.nonEmpty('authorizationtemp cannot be empty')
  )
}
)
...
export class CreateUserHeaderDto extends createStandardDto(CreateUserHeaderSchema) { }
